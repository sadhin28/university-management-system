    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {(role === "admin" || role === "teacher") && (
        <form onSubmit={handleCreate} className="bg-gray-100/20 hover:shadow-2xl shadow-lg rounded-2xl p-6 mb-6 border">
          ...
          <button type="submit" className="hover:bg-none  hover:border-2 bg-gradient-to-r from-[#1D5A5AFF] to-[#031226FF] to-[#0881B5FF] text-white px-4 py-2 rounded-lg w-full items-center gap-2 md:text-xl text-xs">Publish</button>
        </form>
      )}
        ...
        <div className="space-y-4">
          ...
          {notices.map(n => (
             ...
             <div className="flex items-center justify-between">
              ...
              <Link key={n._id} to={`/ViewNotice/${n._id}`} className="mt-2 bg-blue-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm">View Notice</Link>
             </div>
            </div>
