...
export default function AuthForm() {
 ...
 const provider = new GoogleAuthProvider();
  ...
  return (
    <div className="relative top-10 flex items-center justify-center  px-1 ">
      <div className="border-2  border-[#097C7DFF] hover:shadow-2xl shadow-lg bg-gray-100/20 p-8 rounded-2xl shadow-lg w-full max-w-2xl">
       ...
       {isRegister&& <input
        ...
        <button
          ...
          className="hover:border hover:bg-none bg-gradient-to-r font-bold from-[#1D5A5AFF] to-[#031226FF] to-[#0881B5FF] text-white p-2 rounded-lg  items-center flex justify-center gap-2 md:text-xl  w-full"
        >
